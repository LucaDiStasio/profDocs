...
%                                   SPECIFIERS
%-------------------------------------------------------------------------------
\def\expertise{computational science and aerospace engineering}
\def\position{Study Engineer - Modelling \& Simulation}
\def\company{Airbus}
...
I believe my skills and experience would prove valuable in the service of \company\ and its customers' needs. I am looking forward to a personal interview, and the chance to further discuss the value I could bring to \company\ as a Study Engineer. In the meantime, I wish to thank you for taking the time to consider my application and review my
qualifications.\\[12pt]
Best regards,\\
