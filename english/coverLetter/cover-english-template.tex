...
%                                   SPECIFIERS
%-------------------------------------------------------------------------------
\def\expertise{project management and open science practices}
\def\position{the position of FAIRware Project Consultant}
\def\company{the Research on Research Institute (RoRI)}
...
I believe my skills and experience would prove valuable in the service of the RoRI and its partners' mission. I am looking forward to a personal interview, and the chance to further discuss the value I could bring to the RoRI as a FAIRware Project Consultant. In the meantime, I wish to thank you for taking the time to consider my application and review my
qualifications.\\[12pt]
Best regards,\\
